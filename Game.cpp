...
void Game::run() {
    ...
    const string SCREEN_TITLE = "POC Box2D with SDL2";
    ...
    std::shared_ptr<spic::GameObject> ball = make_shared<spic::GameObject>("Ball");
...
//    std::shared_ptr<spic::Component> co = ball.GetComponent<spic::RigidBody>();
    ...
    wallTopBody->CreateFixture(wallTopFixtureDef);
